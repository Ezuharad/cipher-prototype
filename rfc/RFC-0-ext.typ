...
#figure([!TODO encryption diagram]) <scheme_diagram>
...
#figure([TODO! matrices!]) <initialization_matrices>
...
3. It is desirable that no key can yield a symmetric initial state, as CAs with symmetric initial states will remain symmetric. The chosen constant values were taken from a fractal pattern#footnote([Specifically a Hilbert Curve which was off-center cropped. Square cells containing a ]) which is not locally symmetric, guaranteeing no $K$ can yield a symmetric CA. // TODO: choose fractal
...
// TODO: strength against different attacks.
...
#figure([TODO! Rust impl.]) <reference_code>
